...
if __name__ == '__main__':
    ...
    token = ""
    try:
        token = os.environ['OCS_BOT_TOKEN']
    ...
    repos = (
        ('jhhwang4195', '', ''),
        ('jhhwang4195', 'TIL', '황지현'),
        ('jhhwang4195', 'my_source', '황지현'),
        ('jhhwang4195', 'my_config', '황지현'),
        ('jhhwang4195', 'slackbot', '황지현'),

        ('oingbong', '', ''),
        ('oingbong', 'oingbong.github.io', 'oingbong'),
        ('oingbong', 'minima', 'oingbong'),

        ('Swalloow', '', ''),
        ('Swalloow', 'Swalloow.github.io', 'Swalloow'),
        ('Swalloow', 'pyspark-ml-examples', 'Swalloow'),
        ('Swalloow', 'deeplearning.ai', 'Swalloow'),
    )
